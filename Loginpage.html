                                ...
                                <div class="all-cart-product clearfix">
                                    <div class="single-cart clearfix">
                                        ...
                                        <div class="cart-info">
                                            ...
                                            <p>1 x Rs9.00</p>
                                            <a href="#" class="cart-delete" title="Remove this item"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                                        </div>
                                    </div>
                                    <div class="single-cart clearfix">
                                        <div class="cart-image">
                        ...
                        <ul>
                            ...
                            <li><a href="#">Pages</a>
                                <ul class="sub-menu">
                                    ...
                                    <li><a href="register.html">REgister</a></li>
                                    <li><a href="Loginpage.html">wishlist</a></li>
                                </ul>
                            </li>
                    ...
                    <form action="#">
                        <div class="row">
                            <div class="col-xs-12 mb-20">
                                <label id ="username">Username or email <span class="required">*</span></label>
                                <input name="username" id="username" type="text">
                            </div>
                            <div class="col-xs-12 mb-20">
                                <label id="password">Passwords <span class="required">*</span></label>
                                <input name="password" id="password" type="password">
                            </div>
                            <div class="col-xs-12 mb-20">
                                <input id="Login" name="login" class="inline" type="submit">
                                <label class="inline" for="rememberme">
                                    <input id="forever" id="rememberme" name="rememberme" type="checkbox"> Remember me       
                                </label>
                            </div>
                            <div class="col-xs-12">
            ...
            <div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2 col-xs-12">
				...
				<form  id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="section-sunscribe-form validate" target="_blank" novalidate>
                    <div id="mc_embed_signup_scroll">
                        <label id="mce-EMAIL" class="hidden">Subscribe to our mailing list</label>
...
<div class="footer-top-section footer-top-dark section pt-100 pb-60">
	<div class="container">
		<div class="row">
			...
			<!-- Footer Widget -->
			<div class="footer-widget footer-widget-dark col-md-3 col-sm-6 col-xs-12 mb-40">
				<h5 class="widget-title">Lorem Ipsum</h5>
	...
	<div class="container">
		<div class="row">
			...
			<div class="copyright text-left col-sm-6 col-xs-12">
				<p>Powered by <a href="https://hastech.company/">VALUEWORX</a></p>
			</div>
			<!-- Payment Method -->
